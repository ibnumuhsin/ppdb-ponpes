...
class PrintBuktiController extends Controller
{
    ...
    public function index()
    {
        ...
        if($bukti == null || empty($bukti)){
            ...
            return redirect()->route('santri.pengumuman.index');
            ...
            $pdf->setPaper('A4');
            $pdf->loadView('pages.santri.print.bukti', $data);
            return  $pdf->stream( Auth::user()->no_pendaftaran .'-'. Auth::user()->nama_lengkap . '-Bukti-Kelulusan.pdf');
