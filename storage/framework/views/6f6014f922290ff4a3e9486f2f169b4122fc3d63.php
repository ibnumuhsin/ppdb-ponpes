                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <form action="<?php echo e(route('admin.siswa.store')); ?>" method="POST" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="nisn" id="nisn" class="form-control" value="<?php echo e(old('nisn')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\ppdb-ponpes\resources\views/pages/admin/user/siswa/add.blade.php ENDPATH**/ ?>