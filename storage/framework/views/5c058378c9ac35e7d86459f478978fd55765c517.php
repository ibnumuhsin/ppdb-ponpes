                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="btn-group mb-5">
                            <a href="<?php echo e(route('admin.admin.create')); ?>" class="btn btn-success btn-sm font-weight-bold"><i class="fa fa-plus-circle mr-2"></i>Tambah Data</a>
                        </div>
                                ...
                                <tbody class="text-center">
                                    ...
                                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="<?php echo e(route('admin.admin.edit', $d->id)); ?>" class="btn btn-warning btn-sm"><i class="fa fa-pencil-alt"></i></a>
                                                    ...
                                                    <div class="modal-dialog">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form action="<?php echo e(route('admin.admin.destroy', $d->id)); ?>" method="POST" enctype="multipart/form-data">
                                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\ppdb-ponpes\resources\views/pages/admin/user/admin/index.blade.php ENDPATH**/ ?>