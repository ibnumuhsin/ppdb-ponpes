    ...
    <div class="body">
        ...
        <table style="margin-left: 50px;">
            ...
            <tr>
                ...
                <td>:</td>
                <td><?php echo e($user->no_pendaftaran); ?></td>
            </tr>
        </table>
        <p>Dinyatakan <span>
                <?php if($user->status_kelulusan == 1): ?>
                    <span style="font-weight:bold;">LULUS/DITERIMA</span>
                <?php elseif($user->status_kelulusan == 2): ?>
...
<?php /**PATH C:\laragon\www\ppdb-ponpes\resources\views/pages/admin/print/bukti.blade.php ENDPATH**/ ?>