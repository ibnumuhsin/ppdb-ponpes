                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="nama_lengkap"id="nama" class="form-control" value="{{ Auth::user()->nama_lengkap }}">
                                                    @error('nama_lengkap')
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="tmp_lahir" id="tmp" class="form-control" value="{{ Auth::user()->tmp_lahir }}">
                                                                @error('tmp_lahir')
                                                                    <small class="text-danger">{{ $message }}</small>
                                                                @enderror
                                                            </div>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="date" id="tgl" name="tgl_lahir" class="form-control" value="{{ Str::substr(Auth::user()->tgl_lahir, 0, -9) }}">
                                                                @error('tgl_lahir')
                                                                    <small class="text-danger">{{ $message }}</small>
                                                                @enderror
                                                            </div>
